...
<%-- 					<c:forEach items="categoryList" item="category"> --%>
			...
			$.post(
					...
					function(data){
						...
						for(var i=0;i<data.length;i++){
							content+="<li><a href='${pageContext.request.contextPath}/product?method=getProductByCid&cid="+data[i].cid+"'>"+data[i].cname+"</a></li>";
