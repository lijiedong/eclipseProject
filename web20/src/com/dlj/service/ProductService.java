...
public class ProductService {
	...
	public List<Product> findAllProductSer() throws SQLException {
		// TODO Auto-generated method stub
		ProductDao dao = new ProductDao();
		List<Product> productList = dao.findAllProductDao();
		return productList;
	}

	public PageBean findPageBeanSer(int currentPage, int currentCount) throws SQLException {
		ProductDao dao = new ProductDao();
